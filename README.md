...
pixi add enpt_enmapboxapp
# for installing globally
pixi global install enpt_enmapboxapp
```
...
It is possible to list all of the versions of `enpt_enmapboxapp` available on your platform:
...
```
pixi search enpt_enmapboxapp --channel conda-forge
```
